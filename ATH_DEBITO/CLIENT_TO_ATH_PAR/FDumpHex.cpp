...
RWCString FDumpHex::GetMesageLengthInAscii(int incoming_field )
{
...
RWCString FDumpHex::SetTcpHeaderInAscii(RWCString incoming_msg )
{

	 
	int incoming_field = incoming_msg.length();
