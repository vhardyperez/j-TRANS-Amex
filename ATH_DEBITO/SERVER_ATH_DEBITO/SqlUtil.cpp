// SqlUtil.cpp: implementation of the SqlUtil class.
//
//////////////////////////////////////////////////////////////////////
...
void SqlUtil::Proccess_Message( RWCString incoming_msg )
{
	RWCString output_to_b24 ;
	RWCString incoming_visaf;
//	char begingoftext = '\x02';
//	char endoftext    = '\x03';
...
*/
int SqlUtil::GetMesageLength( char *incoming_msg ) 
{
...
RWCString  SqlUtil::RetornoASCII(char  hex_input)
{
...
int SqlUtil::ResultOfParametros(RWCString incoming)
{
...
int SqlUtil::ResultOfParametrosITBIS(RWCString incoming)
{
...
BOOL SqlUtil::setIso8583B240210( ) 
{
...
BOOL SqlUtil::VerifyFieldBeginOfText(RWCString incomingS)
{
...
BOOL SqlUtil::VerifyFieldEndOfText(RWCString incomingS)
{
...
int SqlUtil::SetVisaField(RWCString incoming) 
{
...
BOOL SqlUtil::setIsoGeneric( RWCString incoming) 
{
...
BOOL SqlUtil::setIsoGeneric0210( RWCString incoming) 
{
...
BOOL SqlUtil::setIsoGenericITBIS( RWCString incoming) 
{
...
BOOL SqlUtil::setIsoGenericITBIS0210( RWCString incoming) 
{
...
RWCString SqlUtil::SetField( int input_field ,RWCString field_value) 
{
	char incoming_field[256] = {""};
...
RWCString SqlUtil::setIsoMsg0210()
{
...
RWCString SqlUtil::setIsoMsgItbis()
{
...
RWCString SqlUtil::getIsoMsgGeneric()
{
...
RWCString SqlUtil::SetB24Header0200Pos( RWCString incoming_header ) 
{
...
void SqlUtil::MessageErrorLength(RWCString incoming_name, int wrong_field_length, 
...
int SqlUtil::VerifyNumericField(char *incoming_field, const int length_field, 
...
int SqlUtil::VerifyHexField(char *incoming, const int length_field,RWCString validated_field)
{
...
RWCString SqlUtil::SetMsgField( int input_field ) 
{
...
RWCString SqlUtil::SetMsgField( int input_field ,RWCString field_value, RWCString pre_field) 
{
	char incoming_field[256] = {""};
...
RWCString SqlUtil::SetMsgField( int input_field ,RWCString field_value) 
{
	char incoming_field[256] = {""};
		char buffer[20];
