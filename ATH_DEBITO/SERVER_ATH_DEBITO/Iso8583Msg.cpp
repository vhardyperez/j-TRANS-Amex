...
RWCString  Iso8583Msg::GetTheIniFileInformation()
{
...
RWCString Iso8583Msg::SendMessageToQueueNew(RWCString incoming, char *send_queue_input, char *queue_mgr_input)
{
...
RWCString Iso8583Msg::setGenericFromGenericVar( RWCString incoming)
{
...
BOOL Iso8583Msg::VerifyIsoField( RWCString input_msg, int input_field) 
{
...
RWCString Iso8583Msg::getTrack2FromGenericVar( RWCString incoming)
{
...
void Iso8583Msg::showFieldFromGenericVar( RWCString incoming,int debug)
{
...
void Iso8583Msg::ShowFieldIso8583B24(RWCString incoming , char *msg_type, 
...
void Iso8583Msg::ReturnIso8583FieldValue(char *msg_type, int field_value, RWCString field_name)
{
...
RWCString Iso8583Msg::SendMessageToQueue(RWCString incoming, char *send_queue1,char *queue_mgr1)
{
...
RWCString Iso8583Msg::Get_Msg_From_SendQueueNew( RWCString key_message,  char *send_queue,char *queue_mgr)
{
	  /*   Declare MQI structures needed                                */
   MQOD     od = {MQOD_DEFAULT};    /* Object Descriptor             */
   MQMD     md = {MQMD_DEFAULT};    /* Message Descriptor            */
...
RWCString Iso8583Msg::Get_Msg_From_Queue(   char *send_queue,char *queue_mgr)
