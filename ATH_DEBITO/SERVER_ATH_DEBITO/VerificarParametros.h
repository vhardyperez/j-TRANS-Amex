// VerificarParametros.h: interface for the VerificarParametros class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_VERIFICARPARAMETROS_H__19860181_74E8_4155_8C73_4B75CBE8422D__INCLUDED_)
#define AFX_VERIFICARPARAMETROS_H__19860181_74E8_4155_8C73_4B75CBE8422D__INCLUDED_
...
public:
	...
	int ResultOfParametrosATH(RWCString incoming);
    int ResultOfParametrosAvs0420(RWCString incoming);
	int ResultOfParametrosATHDebito(RWCString incoming);
	int ResultOfParametros0420ATHDebito(RWCString incoming);
	int ResultOfParametrosATHCredito(RWCString incoming);
	int ResultOfParametrosAVS(RWCString incoming);
	int ResultOfParametrosATHDebitoITBIS(RWCString incoming);
	int ResultOfParametrosAVS1C(RWCString incoming);
	int ResultOfParametrosAvs04201C(RWCString incoming);
...
#endif // !defined(AFX_VERIFICARPARAMETROS_H__19860181_74E8_4155_8C73_4B75CBE8422D__INCLUDED_)
