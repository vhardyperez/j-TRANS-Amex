// IsoUtilityVar.cpp: implementation of the IsoUtilityVar class.
//
//////////////////////////////////////////////////////////////////////
...
RWCString  IsoUtilityVar::GetTheIniFileInformation()
{
...
RWCString  IsoUtilityVar::GetTheIniFileInformationATHDebito()
{
	const static char* appName = "BSOURCES_TO_B24";
	...
	GetPrivateProfileString(appName,"send_queue_saf","",send_queue_saf,sizeof(send_queue_saf),appAddr);
	...
	return send_queue+comma+send_queue_eps+comma+send_queue_amex+comma+recv_queue+comma
		   +sql_queue+comma+queue_mgr+comma+header_ini+comma+application+comma+send_queue_saf;
...
RWCString IsoUtilityVar::setMapIsoPosTermFromGeneric( RWCString incoming, char *application, char *header_msg ,int debug)
{
...
BOOL IsoUtilityVar::VerifyIsoField( RWCString input_msg, int input_field) 
{
	...
	{	
		...
		if (input_field == 5)
		{
			...
			{
				MessageErrorLength(RWCString("transaction_amount_itbis"),
			...
			if ( (VerifyNumericField(incoming_field,12 ,
					RWCString("transaction_amount_itbis"))) == 0)
			{
				flag_salida = FALSE;
				break;
			}
...
RWCString IsoUtilityVar::getTrack2FromGenericVar( RWCString incoming)
{
...
RWCString IsoUtilityVar::getGeneric0210FromVar( RWCString incoming, RWCString error_value)
{
...
//	RWCString header_tpdu = header_msg;
	...
	{	
		...
		else
		{
			...
			if ((atoi(field_number) == 3))
			{
				msg_reponse_with_tcp_header += "00003"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
				
			if ((atoi(field_number) == 4))
			{
				msg_reponse_with_tcp_header += "00004"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 7))
			{
				msg_reponse_with_tcp_header += "00007"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 11))
			{
				msg_reponse_with_tcp_header += "00011"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 12))
			{
				msg_reponse_with_tcp_header += "00012"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 13))
			{
				msg_reponse_with_tcp_header += "00013"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}

		
			if ((atoi(field_number) == 37))
			{
				msg_reponse_with_tcp_header += "00037"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
		}
	...
	return "0210"+delimiter+msg_reponse_with_tcp_header+"00038000000"+delimiter+"00039"+error_value+"\n";
}
...
//	RWCString header_tpdu = header_msg;
	RWCString valor_field;
	RWCString msg_reponse_with_tcp_header = "";
	RWCString msg_reponse_with_tcp_header_2 = "";
	RWCTokenizer next(incoming);
	RWCTokenizer next2(incoming);
	RWCString token;
	RWCString token2;
	...
	{	
		...
		else
		{
			...
			if ((atoi(field_number) == 14))
			{
				msg_reponse_with_tcp_header += "00014"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}

			if ((atoi(field_number) == 17))
			{
				msg_reponse_with_tcp_header += "00017"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}

			if ((atoi(field_number) == 18))
			{
				msg_reponse_with_tcp_header += "00018"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 22))
			{
				msg_reponse_with_tcp_header += "00022"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
		
			if ((atoi(field_number) == 25))
			{
				msg_reponse_with_tcp_header += "00025"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 32))
			{
				msg_reponse_with_tcp_header += "00032"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 35))
			{
				msg_reponse_with_tcp_header += "00035"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			...
			if ((atoi(field_number) == 41))
			{
				msg_reponse_with_tcp_header_2 += "00041"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}
		
			if ((atoi(field_number) == 43))
			{
				msg_reponse_with_tcp_header_2 += "00043"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}

			if ((atoi(field_number) == 48))
			{
				msg_reponse_with_tcp_header_2 += "00048"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}

			if ((atoi(field_number) == 49))
			{
				msg_reponse_with_tcp_header_2 += "00049"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}


			if ((atoi(field_number) == 60))
			{
				msg_reponse_with_tcp_header += "00060"+valor_field;
				msg_reponse_with_tcp_header += delimiter;
			}
			if ((atoi(field_number) == 61))
			{
				msg_reponse_with_tcp_header_2 += "00061"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}

			if ((atoi(field_number) == 100))
			{
				msg_reponse_with_tcp_header_2 += "00100"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}
		
			if ((atoi(field_number) == 120))
			{
				msg_reponse_with_tcp_header_2 += "00120"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}
			if ((atoi(field_number) == 125))
			{
				msg_reponse_with_tcp_header_2 += "00125"+valor_field;
				msg_reponse_with_tcp_header_2 += delimiter;
			}
	...
	cout << "Valor de msg_reponse_with_tcp_header_2 " << msg_reponse_with_tcp_header_2 << endl;

	
		return "0210"+delimiter+msg_reponse_with_tcp_header+"00038000000"+delimiter+"00039"+error_value+delimiter+msg_reponse_with_tcp_header_2+"\n";
}


void IsoUtilityVar::showFieldFromGenericVar( RWCString incoming,int debug)
{
...
void IsoUtilityVar::ShowFieldIso8583B24(RWCString incoming , char *msg_type, 
										          int debug, RWCString application)
{
	...
	IsoUtilityVar test_iso_new;
	IsoUtilityVar get_bit_map_ascii;
...
void IsoUtilityVar::ReturnIso8583FieldValue(char *msg_type, int field_value, RWCString field_name)
{
...
RWCString IsoUtilityVar::setMapIsoPosTermFromGeneric100( RWCString incoming, char *application, char *header_msg ,int debug)
{
...
RWCString IsoUtilityVar::setMapIsoBase24FromGeneric( RWCString incoming, char *application,int debug)
{
...
RWCString IsoUtilityVar::setIsoMsg8583(RWCString message, RWCString input)
{
...
RWCString IsoUtilityVar::setIsoMsg8583All(RWCString message, RWCString input)
{
...
RWCString IsoUtilityVar::getIsoMsg8583(RWCString type)
{
...
RWCString  IsoUtilityVar::RetornoHexadecimalComplete( RWCString ascii_input, int input)
{
...
RWCString  IsoUtilityVar::RetornoAsciiComplete( RWCString ascii_input, int input)
{
	RWCString pin_wk_ascii = ascii_input;
...
RWCString  IsoUtilityVar::RetornoASCII(char  hex_input)
{
...
char  IsoUtilityVar::RetornoHexa( RWCString hex_input)
{
...
RWCString IsoUtilityVar::SetMsgField8583( int input_field ) 
{
...
RWCString IsoUtilityVar::setBitMap( RWCString input_four_bit)
{
...
RWCString IsoUtilityVar::setBitMapFromChar( RWCString input_four_bit)
{
...
/*
RWCString IsoUtilityVar::SetB24Header0200Pos( RWCString incoming_header ) 
{
...
*/
void IsoUtilityVar::MessageErrorLength(RWCString incoming_name, int wrong_field_length, 
						int correct_field_length) 
{
	...
	cout << "El largo de " <<  incoming_name << " es incorrecto > " 
		 ...
		 cout << "***********Transaccion abortada2********** > " << endl;

}

int IsoUtilityVar::VerifyNumericField(char *incoming_field, const int length_field, 
...
int IsoUtilityVar::VerifyHexField(char *incoming, const int length_field,RWCString validated_field)
{
...
/*
RWCString IsoUtilityVar::SetField( int input_field ,RWCString field_value) 
{
	char incoming_field[256] = {""};
...
RWCString IsoUtilityVar::SetMsgField( int input_field ) 
{
...
RWCString IsoUtilityVar::SetMsgField( int input_field ,RWCString field_value, RWCString pre_field) 
{
	char incoming_field[256] = {""};
...
/*
void IsoUtilityVar::ReturnDumpIsoGeneric( char *msg_type, int debugSB, RWCString peerAddress, int server_port) 
{
...
*/
int IsoUtilityVar::SendMessageToQueueSql(RWCString incoming, char *sql_queue, char *queue_mgr)
{
...
RWCString IsoUtilityVar::SendMessageToQueue(RWCString incoming, char *send_queue1,char *queue_mgr1)
{
...
//	cout << "Despues #2>>> " << endl;
  ...
  if ( pchannel ) {
	...
	strcpy(application_string,application);
 	...
 	IsoBitMap msg_return;
	IsoUtilityVar set_tcp_header1;
	char recv_0210[1024] = {""};
...
int IsoUtilityVar::SendMessageToQueueNoTimeout(RWCString incoming, char *recv_queue,char *queue_mgr)
{
...
RWCString IsoUtilityVar::Get_Msg_From_SendQueue(   char *send_queue,char *queue_mgr)
...
RWCString IsoUtilityVar::Get_Msg_From_Queue(   char *send_queue,char *queue_mgr)
...
/*
RWCString IsoUtilityVar::Get_Msg_From_Sock( RWSocketPortal p,  char *send_queue,char *queue_mgr)

{
   ...
   RWCString retorno_msg = "";
	...
	if((test_1(11,4)) == "0800")
	{
		IsoUtilityVar test_send_0800;
		retorno_msg = test_send_0800.setIsoGeneric0800(test_1) ;
	}
	if((test_1(11,4)) == "0200")
	{
		IsoUtilityVar test_send_0200;
...
RWCString IsoUtilityVar::Send_Msg_To_Sock( RWSocketPortal p,  char *send_queue,char *queue_mgr)
...
int IsoUtilityVar::Send_Message_0210(char *input_msg )
{
...
RWCString IsoUtilityVar::SetTcpHeader( RWCString incoming_tcp_header ) 
...
char IsoUtilityVar::RetornoHexadecimal(RWCString hex_input)
{
